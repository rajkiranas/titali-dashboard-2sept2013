 ...
 * @author sonalis
 */
public class SearchTeacherFilter extends Window implements Button.ClickListener {
    ...
    public SearchTeacherFilter(TeacherView  teacherView) {
        this.teacherView=teacherView;
        VerticalLayout l = new VerticalLayout();
        l.setSpacing(true);
        setCaption("Search Teacher");
        setContent(l);
        center();
        setModal(true);
        ...
        searchCriteriacmb.addItem("Teacher Name");               
    ...
    public void buttonClick(ClickEvent event) {
       ...
       if(source==applyFilterbtn){
           if(validateSearchFilter()){
               ...
               teacherView.searchFilterCriteria(searchCriteria,searchValue);
               this.close();         
           }
        }
    }
